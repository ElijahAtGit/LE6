...
namespace BlogDataLibrary.Data
{
    public class SqlData : ISqlData
    {
        ...
        /*Checks if parameters are in database, if not, return null*/
        public UserModel Authenthicate(string username, string password)
        {
            UserModel result = _db.LoadData<UserModel, dynamic>("BlogDB.dbo.spUsers_Authenticate",
        ...
        {
            return _db.LoadData<ListPostModel, dynamic>("BlogDB.dbo.spPosts_Details", new { id }, connectionStringName, true).FirstOrDefault();
        }
    }
}
